var whiteboard = {
	...
	loadWhiteboard: function (whiteboardContainer, newSettings) {
		...
		var onePerHeight = (Number(window.screen.height)/100);
		var onePerWidth = (Number(window.screen.width)/100)
		_this.settings.canvasHeight=Number(Number(window.screen.height)-(20 * onePerHeight));
		_this.settings.canvasWidth=Number(Number(window.screen.width)-(20 * onePerWidth));
		console.log(_this.canvasHeight,_this.canvasWidth);

		document.getElementById('board_block').style.height = _this.settings.canvasHeight + "px";
		document.getElementById('board_block').style.width = _this.settings.canvasWidth + "px";
